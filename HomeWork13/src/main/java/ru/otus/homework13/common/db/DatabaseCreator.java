...
public class DatabaseCreator {
    ...
    public static boolean createHomework13Database(DBSettings settings){
        boolean res = false;
    ...
    public static boolean dropHomework13Database(DBSettings settings) {
    ...
    public static void main(String[] args) {
        ...
        DatabaseCreator.createHomework13Database(settings);
    }
}
